...
**
** Created: Sun Mar 6 00:51:57 2011
...
static const char qt_meta_stringdata_ConsoleWindow[] = {
    "ConsoleWindow\0\0readOutput()\0readError()\0"
    "clearLog()\0killProcess()\0"
};

const QMetaObject ConsoleWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ConsoleWindow,
      qt_meta_data_ConsoleWindow, 0 }
};
...
int ConsoleWindow::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: readOutput(); break;
        case 1: readError(); break;
        case 2: clearLog(); break;
